...
Compare the differences and explain why. \(using RSEM: [https://github.com/deweylab/RSEM](https://github.com/deweylab/RSEM), please check _rsem-prepare-reference_ and _rsem-tbam2gbam _functions\)
