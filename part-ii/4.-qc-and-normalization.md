...
First, we compare the different of  log-transformation counts and raw counts. 
...
![](../.gitbook/assets/pca-log2-before.png)

Then, we compare the PCA results before and after QC.
...
**After QC with log-transformation**
...
![](../.gitbook/assets/pca-log2-after.png)

### The tSNE map

 tSNE \(t-Distributed Stochastic Neighbor Embedding\) combines dimensionality reduction \(e.g. PCA\) with random walks on the nearest-neighbour network to map high dimensional data.
